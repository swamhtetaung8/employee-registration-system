...
@section('content')
    ...
    <form id="updateForm" action="{{ route('employees.update', $employee->id) }}" method="POST"
        class="bg-body-tertiary border rounded p-3 my-3" enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <div class="d-flex justify-content-between align-items-center">
            <div>
                <p class="fs-4 mb-0"><i class="bi bi-person me-2"></i><span
        ...
        <div class="my-3">
            <div class="row my-4 align-items-end">
                <div class="col-md-3">
                    <img src="{{ asset($employeePhoto) }}" id="employeePhoto" width="180" height="180"
                        class="object-fit-cover rounded-pill" alt="Employee photo">
                </div>
                @if ($employee->upload)
                    <div class="col-md-2">
            ...
            <div class="row align-items-center my-3">
                ...
                <div class="col-md-4">
                    <input type="text" name="employee_code"
                        class="form-control @error('employee_code')
                            is-invalid
                        @enderror"
            ...
            <div class="row align-items-center my-3">
                ...
                <div class="col-md-4">
                    <input type="text" name="employee_name"
                        class="form-control @error('employee_name')
                            is-invalid
                        @enderror"
            ...
            <div class="row align-items-center my-3">
                ...
                <div class="col-md-4">
                    <input type="text" name="nrc_number"
                        class="form-control @error('nrc_number')
                            is-invalid
                        @enderror"
            ...
            <div class="row align-items-center my-3">
                ...
                <div class="col-md-4">
                    <input type="text" name="email_address"
                        class="form-control @error('email_address')
                            is-invalid
                        @enderror"
            ...
            <div class="row align-items-center my-3">
                ...
                <div class="col-md-4 d-flex gap-3">
                    <div class=" form-check">
                        ...
                        <input type="radio" id="male" name="gender" value="1" class=" form-check-input"
                            {{ $employee->gender == 1 || old('gender') == 1 ? 'checked' : '' }}>
                    </div>
                    <div class=" form-check">
                        ...
                        <input type="radio" id="female" name="gender" value="2" class=" form-check-input"
                            {{ $employee->gender == 2 || old('gender') == 2 ? 'checked' : '' }}>
                    </div>
                </div>
            </div>
            <div class="row align-items-center my-3">
                <div class="col-md-3">
                    <label for="" class="form-label">@lang('public.date_of_birth')<span
            ...
            <div class="row align-items-center my-3">
                ...
                <div class="col-md-4 d-flex gap-3">
                    <select name="marital_status" class="form-select" id="">
                        ...
                        <option value="1"
                            {{ $employee->marital_status == 1 || old('marital_status') == 1 ? 'selected' : '' }}>
                            @lang('public.single')</option>
                        <option value="2"
                            {{ $employee->marital_status == 2 || old('marital_status') == 2 ? 'selected' : '' }}>
                            @lang('public.married')</option>
                        <option value="3"
                            {{ $employee->marital_status == 3 || old('marital_status') == 3 ? 'selected' : '' }}>
                            @lang('public.divorced')</option>
                    </select>
                </div>
            </div>
            <div class="row my-3">
        ...
        <div class="d-flex justify-content-center mt-5 mb-3">
            <button form="updateForm" class=" btn btn-primary px-5 py-2" type="submit">@lang('public.update')</button>
        </div>
    </form>
@endsection
